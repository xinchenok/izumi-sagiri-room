...
房门舞台由银蓝走廊、草莓墙纸内景、人物 PNG、透视门板、门牌、门把和稿纸卡叠成。初始状态只能偷看；敲门后人物先受惊，再在默认 760ms 后脸红并开门，门板以 1100ms 绕左侧旋转。桌面布局开门后，人物插画扩展至整个门框，前景门板在旋转中淡出，由插画内的木门自然接管构图，不能留下粉色竖条或残破门牌。门牌承担身份，门把承担视觉引导，稿纸承担台词，猫爪按钮承担许可动作，四者不可互相替代。
